...
export EKS_CLUSTER_NAME="flaskapp1-demo-shop"
export APP_DIR="../../../app1/"
...
aws iam create-role --role-name flaskappEKSClusterRole --assume-role-policy-document file://"eks-cluster-role-trust-policy.json"

#Step 1.4: Attach the Amazon EKS cluster policy to the role
aws iam attach-role-policy --policy-arn arn:aws:iam::aws:policy/AmazonEKSClusterPolicy --role-name flaskappEKSClusterRole
